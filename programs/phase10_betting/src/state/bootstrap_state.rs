...
impl BootstrapState {
    ...
    pub fn init(&mut self, clock: &Clock) -> Result<()> {
        ...
        self.initial_coverage = U64F64::zero();
        self.current_coverage = U64F64::zero();
        self.target_coverage = U64F64::one(); // 1.0 = 100% coverage
        self.start_slot = clock.slot;
        self.expected_end_slot = clock.slot + 38_880_000; // 6 months
        self.early_bonus_multiplier = U64F64::from_num(2u32); // 2x for early traders
    ...
    pub fn calculate_mmt_reward(
        ...
        let total_reward = U64F64::from_num(base_reward as u64) * multiplier;
