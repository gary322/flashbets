...
impl BootstrapIncentiveEngine {
    ...
    pub fn get_trader_tier(volume: u64) -> IncentiveTier {
        match volume {
            v if v >= 1_000_000 * 10u64.pow(6) => IncentiveTier {
                ...
                reward_multiplier: U64F64::from_num(3u32),
                fee_rebate_bps: 15,
            ...
            v if v >= 100_000 * 10u64.pow(6) => IncentiveTier {
                ...
                reward_multiplier: U64F64::from_num(2u32),
                fee_rebate_bps: 10,
            ...
            v if v >= 10_000 * 10u64.pow(6) => IncentiveTier {
                ...
                reward_multiplier: U64F64::from_num(3u32) / U64F64::from_num(2u32), // 1.5
                fee_rebate_bps: 5,
    ...
    pub fn calculate_bootstrap_coverage(
        ...
        let tail_loss = if bootstrap_phase {
            U64F64::from_num(7u32) / U64F64::from_num(10u32) // 0.7
        } else {
            U64F64::from_num(1u32) / U64F64::from_num(2u32) // 0.5
        };
    ...
    pub fn process_referral(
        ...
        let referral_rate = U64F64::from_num(5u32) / U64F64::from_num(100u32); // 0.05
