...
impl HybridAMMSelector {
    ...
    pub fn calculate_switching_cost(
        ...
        let complexity_multiplier = match (self.amm_type, new_amm) {
            (AMMType::LMSR, AMMType::PMAMM) => U64F64::from_num(6u32) / U64F64::from_num(5u32), // 1.2
            (AMMType::PMAMM, AMMType::L2Distribution) => U64F64::from_num(3u32) / U64F64::from_num(2u32), // 1.5
            (AMMType::L2Distribution, _) => U64F64::from_num(2u32),
            _ => U64F64::one(),
        };
    ...
    fn calculate_efficiency_score(&self) -> u8 {
        ...
        if self.performance_metrics.total_volume > 0 {
            ...
            if lvr_ratio > U64F64::from_num(1u32) / U64F64::from_num(100u32) { // >1% LVR
