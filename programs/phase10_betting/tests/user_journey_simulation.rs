...
use phase10_betting::state::{BootstrapState, BootstrapTrader, IncentiveTier};
use phase10_betting::bootstrap::BootstrapIncentiveEngine;
use phase10_betting::router::{RouteExecutor, types::*};
use phase10_betting::amm::types::{MarketType, AMMType};
...
fn simulate_early_trader_journey() {
    ...
    // 5. Check milestone
    let milestones = bootstrap::MilestoneManager::get_bootstrap_milestones();
