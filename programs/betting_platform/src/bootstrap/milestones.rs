...
impl MilestoneManager {
    ...
    pub fn get_bootstrap_milestones() -> Vec<(u64, U64F64, u64, u64)> {
        ...
        vec![
            (1_000 * 10u64.pow(6), U64F64::from_num(0.1), 10, 10_000 * 10u64.pow(6)),
            (10_000 * 10u64.pow(6), U64F64::from_num(0.25), 50, 50_000 * 10u64.pow(6)),
            (50_000 * 10u64.pow(6), U64F64::from_num(0.5), 100, 100_000 * 10u64.pow(6)),
            (100_000 * 10u64.pow(6), U64F64::from_num(0.75), 500, 200_000 * 10u64.pow(6)),
            (500_000 * 10u64.pow(6), U64F64::from_num(1.0), 1000, 500_000 * 10u64.pow(6)),
        ]
    }
