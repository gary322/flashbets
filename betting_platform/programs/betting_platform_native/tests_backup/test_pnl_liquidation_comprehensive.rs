...
mod comprehensive_pnl_tests {
    ...
    use betting_platform_native::{
        ...
        liquidation::{
            ...
            formula_verification::verify_liquidation_calculation,
        },
        math::U64F64,
...
fn main() {
    println!("Running comprehensive PnL liquidation tests...");
    
    // Run all tests
    comprehensive_pnl_tests::test_pnl_calculation_accuracy();
    comprehensive_pnl_tests::test_effective_leverage_calculation();
    comprehensive_pnl_tests::test_dynamic_liquidation_price();
    comprehensive_pnl_tests::test_liquidation_scenarios();
    comprehensive_pnl_tests::test_coverage_based_liquidation_with_pnl();
    comprehensive_pnl_tests::test_margin_ratio_calculation();
    comprehensive_pnl_tests::test_update_with_price_integration();
    comprehensive_pnl_tests::test_edge_cases();
    comprehensive_pnl_tests::test_formula_verification();
    comprehensive_pnl_tests::test_short_position_liquidation();
    comprehensive_pnl_tests::test_liquidation_price_spec_formula();
    comprehensive_pnl_tests::test_comprehensive_scenario();
    comprehensive_pnl_tests::test_batch_performance();
