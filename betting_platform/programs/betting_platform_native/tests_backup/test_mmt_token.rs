...
impl TestEnv {
    ...
    async fn initialize_mmt(&mut self) -> Result<(), BanksClientError> {
        ...
        let instruction = Instruction {
            ...
            data: BettingInstruction::InitializeMMTToken.try_to_vec().unwrap(),
        };
    ...
    async fn initialize_staking_pool(&mut self) -> Result<(), BanksClientError> {
        let instruction = Instruction {
            ...
            data: BettingInstruction::InitializeStakingPool.try_to_vec().unwrap(),
        };
...
async fn test_maker_rewards() {
    ...
    let instruction = Instruction {
        ...
        data: BettingInstruction::InitializeEarlyTraderRegistry { season: 1 }.try_to_vec().unwrap(),
    };
    ...
    let instruction = Instruction {
        ...
        data: BettingInstruction::RegisterEarlyTrader { season: 1 }.try_to_vec().unwrap(),
    };
...
async fn test_season_transition() {
    ...
    let instruction = Instruction {
        ...
        data: BettingInstruction::TransitionSeason.try_to_vec().unwrap(),
    };
