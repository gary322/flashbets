...
async fn test_stale_polymarket_price_rejected() {
    ...
    let stale_feed = MarketPriceFeed {
        ...
        last_update_slot: current_slot - MAX_PRICE_AGE_SLOTS - 1, // Too old
        last_update_timestamp: 1234567890,
...
async fn test_polymarket_confidence_threshold() {
    ...
    let result = MedianOracleHandler::calculate_median_price(
        Some(OraclePriceData {
            ...
            timestamp: low_confidence_feed.last_update_timestamp,
            slot: low_confidence_feed.last_update_slot,
        }),
        None,
        None,
        1001,
