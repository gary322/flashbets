...
use betting_platform_native::{
    ...
    state::{
        accounts::{discriminators, GlobalConfigPDA, ProposalPDA, Position, UserStats},
...
async fn test_user_deposit_and_credit_journey() {
    ...
    let init_credits_ix = Instruction {
        ...
        data: BettingPlatformInstruction::InitializeUserCredits.try_to_vec().unwrap(),
    };
    ...
    let deposit_ix = Instruction {
        ...
        data: BettingPlatformInstruction::DepositCredits { 
