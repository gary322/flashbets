...
mod tests {
    use betting_platform_native::math::{
        ...
        table_lookup::{lookup_cdf, lookup_pdf, lookup_erf},
        special_functions::black_scholes_call,
        U64F64,
    };
    use betting_platform_native::amm::pmamm::table_integration::{
    ...
    fn test_table_initialization() {
        let tables = NormalDistributionTables {
            discriminator: [0x4e, 0x6f, 0x72, 0x6d, 0x54, 0x62, 0x6c, 0x73], // "NormTbls"
    ...
    fn test_cdf_lookup_known_values() {
        ...
        for (x, expected) in test_cases {
            let x_fp = U64F64::from_num(x.abs() as f64 as u64);
    ...
    // TODO: Implement calculate_var function or use process_calculate_portfolio_var
    /*
    #[test]
